...
COMPILE_OPTS =		$(INCLUDES) -I/usr/local/include -I ../arduino -I. -O2 -g -DSOCKLEN_T=socklen_t -D_LARGEFILE_SOURCE=1 -D_FILE_OFFSET_BITS=64 -DALLOW_RTSP_SERVER_PORT_REUSE=1 -DARDUINO -DESP32
C =			c
C_COMPILER =		cc
