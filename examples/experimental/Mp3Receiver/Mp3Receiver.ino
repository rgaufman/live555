...
// forward declarations of used methods
...
void setup() {
  ...
  // Selects the Arduino File implmentation
  setFileDriver(new FileAccessSD());
  ...
  sessionState.rtcpInstance =
      RTCPInstance::createNew(*env, &rtcpGroupsock, estimatedSessionBandwidth,
                              CNAME, NULL /* we're a client */, rtpSource);
